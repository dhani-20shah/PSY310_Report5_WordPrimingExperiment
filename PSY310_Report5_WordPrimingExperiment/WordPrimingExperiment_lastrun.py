...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\dhani\\OneDrive\\Desktop\\PSY310_Report5_WordPrimingExperiment\\WordPrimingExperiment_lastrun.py',
